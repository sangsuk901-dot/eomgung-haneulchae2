      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="reveal relative" style={{ animationDelay: '0.2s' }}>
            <div className="absolute -inset-4 bg-indigo-500/5 rounded-[3.5rem] blur-3xl"></div>
            {/* 단지 조감도 이미지 - 텍스트 오버레이 제거 */}
            <div className="relative aspect-[3/2] rounded-[2.5rem] overflow-hidden shadow-2xl bg-neutral-100 group border border-neutral-100/50">
              <img 
            ...
            {/* 장식 요소 */}
            <div className="absolute -top-6 -right-6 w-24 h-24 bg-indigo-100 rounded-full mix-blend-multiply filter blur-2xl opacity-70 animate-pulse"></div>
            <div className="absolute -bottom-6 -left-6 w-32 h-32 bg-purple-100 rounded-full mix-blend-multiply filter blur-2xl opacity-70 animate-pulse" style={{ animationDelay: '2s' }}></div>
          </div>
        </div>
      </div>
    </section>
